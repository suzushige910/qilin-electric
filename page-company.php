...
<main id="primary" class="site-main company-page">
    ...
    <section class="page-header" style="background: linear-gradient(135deg, #628141 0%, #8BAE66 100%);">
        <div class="container">
            ...
            <p class="page-subtitle">エネルギーの未来を創造する</p>
        </div>
    </section>
    ...
    <!-- 代表挨拶 -->
    <section class="message-section bg-light">
        <div class="container">
    ...
    <!-- アクセス -->
    <section class="access-section bg-light">
        <div class="container">
    ...
    <!-- CTAセクション -->
    <section class="company-cta" style="background-color: #628141;">
        <div class="container">
